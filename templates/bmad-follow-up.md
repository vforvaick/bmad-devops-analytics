# BMAD Follow-Up Package: [Reviewed Deployment]
...
## Summary
[Short summary of why BMAD needs to run a follow-up workflow.]
...
- **Change Type**: [active-sprint correction | future-planning update | both]
...
## Expected Outcome
1. [primary expected result]
2. [secondary expected result]
